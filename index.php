    ...
    <div class="modal fade" id="modal_gallery" role="dialog">
      ...
      <div class="modal fade" id="myModal" role="dialog">
        ...
        <header class="header bg-black">
            ...
            <!--logo start-->
            <a href="index.php" class="logo"><b>WebGIS Worship Place (19 1811522020 Nurul Afifah)</b></a>
            <div class="top-menu">
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <p class="centered"><a href="profile.html"><img src="assets/img/1.jpg" class="img-circle" width="90" style="border-radius: 50%"></a></p>
                  ...
                  <li class="sub-menu">
                      <a href="javascript:;" onclick="hapusall();tampilsemua();resultt()" >
...
<?php
 ...
 <li class="sub-menu">
      ...
      <section id="main-content">
          ...
          <div id="rute1" class="row" style="display:none">
                      <div class="col-md-12 col-sm-12 mb">
                        <div class="white-panel pns" style="height:auto;padding-bottom:20px">
                           <div style="margin:0px 20px 10px 20px">
                             <h5 class="btn btn-compose bg-black" >Route</h5>
                           </div>
                      <div class="form-group">
                        <table class="table table-bordered" id='rute'>
                        </table>  
                      </div>                   
                          ...
                          <div style="height:410px; margin:20px;">
                            <div class="container2">
                              <div class="row2" >
                                ...
                                <div class="mySlides">
                                  <a href="" onclick="galeri('M0001')"><img src="foto/M0001_DARUSSALAM GURUN PANJANG.JPG" style="width:100%; height: 260px;"><div class="text bg-black">Masjid Darussalam Gurun Panjang</div></a>
                                </div>
                                <div class="mySlides">
